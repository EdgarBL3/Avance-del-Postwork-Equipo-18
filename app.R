    ...
    mainPanel( 
        tabsetPanel(
            ...
            tabPanel("Distribuciones de los goles", #Pestaña donde mostraremos lo hecho en el postwork 3
                p("\n"),
                h5("FTHG"),
                img( src = "FTHG.png", height = 300, width = 600),#Distribucion del numero de goles de casa
                h5("FTAG"),
                img( src = "FTAG.png", height = 300, width = 600),#Distribucion del numero de goles de visitante
                h5("Heatmap"),
                img( src = "Heatmap.png", height = 300, width = 600)),#Distribucion de probabilidad conjunta
            ...
            tabPanel("Momios", #Se muestran los escenarios maximo y promedio de los momios
                ...
                img( src = "Img1.jpeg", height = 314, width = 500),
                h5("Escenario con momios promedio"),
                img( src = "Img2.jpeg", height = 314, width = 500)
            )
        )
    )
)
