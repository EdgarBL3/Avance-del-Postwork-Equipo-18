...
p<-marginal_FTHG %>%
  ...
  ylab("Probabilidad")+
  ggtitle("Probabilidad marginal del n̼mero de goles que anota el equipo de casa")
ggplotly(p)
...
p<-marginal_FTAG %>%
  ...
  xlab("N̼mero de goles")+
  ylab("Probabilidad")+
  ggtitle("Probabilidad marginal del n̼mero de goles que anota el equipo visitante")
ggplotly(p)
...
p<-probabilidad_conjunta %>% ggplot()+
  ...
  xlab("N̼mero de goles que anota el equipo de casa")+
  ylab("N̼mero de goles que anota el equipo visitante")+
